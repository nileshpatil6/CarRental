...
const cars = [
    ...
    },
    {
        ...
        category: "economy",
        price: 1500,
        image: "https://images.unsplash.com/photo-1617654112329-c1b9b2d2f58b?w=800&q=80",
    ...
    },
    {
        ...
        category: "suv",
        price: 2800,
        image: "https://images.unsplash.com/photo-1606611013016-969c19ba7278?w=800&q=80",
    ...
    },
    {
        ...
        category: "economy",
        price: 1500,
        image: "https://images.unsplash.com/photo-1609521263047-f8f205293100?w=800&q=80",
        features: ["Manual", "5 Seats", "18km/Ltr", "No hidden charges"],
...
function updateFilterCounts() {
    const counts = {
        all: cars.length,
        economy: cars.filter(car => car.category === 'economy').length,
        premium: cars.filter(car => car.category === 'premium').length,
        suv: cars.filter(car => car.category === 'suv').length,
        mpv: cars.filter(car => car.category === 'mpv').length
    };
...
function bookOnWhatsapp() {
    window.open('https://wa.me/919876543210', '_blank'); // Replace with actual WhatsApp number
}
